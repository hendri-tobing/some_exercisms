defmodule ListOpsTest do
  ...
  describe "foldl" do
    ...
    @tag :slow
    test "huge list" do
      assert L.foldl(Enum.to_list(1..1_000), 0, &(&1 + &2)) ==
               List.foldl(Enum.to_list(1..1_000), 0, &(&1 + &2))
    end
  end
  ...
  describe "foldr" do
    ...
    @tag :slow
    test "huge list" do
      assert L.foldr(Enum.to_list(1..1_000), 0, &(&1 + &2)) ==
               List.foldr(Enum.to_list(1..1_000), 0, &(&1 + &2))
    end
  end
